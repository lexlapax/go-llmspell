...
if mode == "simple" then
    ...
    local id1 = llm.chat_async("What is 2+2?", 
        function(result)
            results[1] = result
    ...
    local id2 = llm.chat_async("What is the capital of France?", 
        function(result)
            results[2] = result
            completed = completed + 1
    ...
    local id3 = llm.complete_async("The meaning of life is", 50,
        function(result)
            results[3] = result
            completed = completed + 1
...
elseif mode == "streaming" then
    ...
    llm.chat_async("Tell me a very short joke",
        function(result)
