...
func (b *StateManagerBridge) Methods() []engine.MethodInfo {
	return []engine.MethodInfo{
		{Name: "createState", Description: "Create a new state object"},
		{Name: "saveState", Description: "Save a state object to persistence"},
		{Name: "loadState", Description: "Load a state object by ID"},
		{Name: "deleteState", Description: "Delete a state object by ID"},
		{Name: "listStates", Description: "List all state IDs"},
		{Name: "registerTransform", Description: "Register a state transform function"},
		{Name: "applyTransform", Description: "Apply a transform to a state"},
		{Name: "registerValidator", Description: "Register a state validator function"},
		{Name: "validateState", Description: "Validate a state using a validator"},
		{Name: "mergeStates", Description: "Merge multiple states using a strategy"},
		{Name: "get", Description: "Get a value from state"},
		{Name: "set", Description: "Set a value in state"},
		{Name: "delete", Description: "Delete a key from state"},
		{Name: "has", Description: "Check if state has a key"},
		{Name: "keys", Description: "Get all keys from state"},
		{Name: "values", Description: "Get all values from state"},
		{Name: "setMetadata", Description: "Set metadata on state"},
		{Name: "getMetadata", Description: "Get metadata from state"},
		{Name: "getAllMetadata", Description: "Get all metadata from state"},
		{Name: "addArtifact", Description: "Add artifact to state"},
		{Name: "getArtifact", Description: "Get artifact from state"},
		{Name: "artifacts", Description: "Get all artifacts from state"},
		{Name: "addMessage", Description: "Add message to state"},
		{Name: "messages", Description: "Get all messages from state"},
	}
}
