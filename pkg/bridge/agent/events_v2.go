...
// EventBridgeV2 provides script access to go-llms v0.3.5 event functionality
type EventBridgeV2 struct {
	mu          sync.RWMutex
	initialized bool
...
// NewEventBridgeV2 creates a new v2.0.0 event bridge
func NewEventBridgeV2() *EventBridgeV2 {
...
func (b *EventBridgeV2) GetID() string {
	return "events"
}

// GetMetadata returns bridge metadata
func (b *EventBridgeV2) GetMetadata() engine.BridgeMetadata {
...
func (b *EventBridgeV2) Initialize(ctx context.Context) error {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *EventBridgeV2) Cleanup(ctx context.Context) error {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *EventBridgeV2) IsInitialized() bool {
	b.mu.RLock()
	defer b.mu.RUnlock()
...
func (b *EventBridgeV2) RegisterWithEngine(engine engine.ScriptEngine) error {
	return engine.RegisterBridge(b)
}

// Methods returns the methods exposed by this bridge
func (b *EventBridgeV2) Methods() []engine.MethodInfo {
...
func (b *EventBridgeV2) TypeMappings() map[string]engine.TypeMapping {
...
func (b *EventBridgeV2) ValidateMethod(name string, args []interface{}) error {
	// Method validation handled by engine based on Methods() metadata
	return nil
}

// RequiredPermissions returns required permissions
func (b *EventBridgeV2) RequiredPermissions() []engine.Permission {
...
func (b *EventBridgeV2) ExecuteMethod(ctx context.Context, name string, args []interface{}) (interface{}, error) {
	b.mu.RLock()
	defer b.mu.RUnlock()
...
func (b *EventBridgeV2) mapToEvent(data map[string]interface{}) domain.Event {
	event := domain.Event{
...
func (b *EventBridgeV2) eventToMap(event domain.Event) map[string]interface{} {
...
func (b *EventBridgeV2) createFilterFromConfig(config map[string]interface{}) (events.EventFilter, error) {
...
func (b *EventBridgeV2) buildEventQuery(config map[string]interface{}) events.EventQuery {
	query := events.EventQuery{
...
func (b *EventBridgeV2) compareValues(fieldValue interface{}, operator string, value interface{}) bool {
	switch operator {
	case "=", "==", "equals":
