...
func (m *MockScriptEngine) FromNative(goValue interface{}) (interface{}, error) { return goValue, nil }
...
func (m *MockBridge) ValidateMethod(name string, args []interface{}) error { return nil }
